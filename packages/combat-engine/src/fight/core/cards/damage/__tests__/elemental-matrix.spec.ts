...
describe('ElementalMatrix', () => {
  describe('getMultiplier', () => {
    ...
    describe('AIR damage type', () => {
      ...
      it('return 1.0 against AIR (same element)', () => {
